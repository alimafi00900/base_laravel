/*! For license information please see form-element-select.js.LICENSE.txt */
(() => {
    var e = {
        4529: e => {
            var t;
                        ...
                        282: function (e, t, i) {
                            ...
                            t.addChoice = function (e) {
                                var t = e.value, i = e.label, o = e.id, r = e.groupId, s = e.disabled, a = e.elementId,
                                    c = e.customProperties, l = e.placeholder, u = e.keyCode;
                                return {
                            ...
                            t.addItem = function (e) {
                                var t = e.value, i = e.label, o = e.id, r = e.choiceId, s = e.groupId,
                            ...
                            var r = o(i(996)), s = o(i(70)), a = i(282), c = i(783), l = i(464), u = i(137), h = i(520),
                                d = i(883), p = i(789), f = i(799), m = i(655), v = o(i(744)), _ = o(i(686)),
                                ...
                                y = {}, E = function () {
                                    ...
                                    return Object.defineProperty(e, "defaults", {
                                        ...
                                        var r = this.config, s = r.renderSelectedChoices, a = r.searchResultLimit,
                                            ...
                                            l = this._isSearching ? f.sortByScore : this.config.sorter, u = function (e) {
                                        ...
                                        var v = h.length, _ = this._isSelectOneElement ? n(n([], p, !0), m, !0) : m;
                                        ...
                                        if (e && this.input.isFocussed) {
                                            var t = this._store.choices, i = this.config, n = i.searchFloor,
                                                o = i.searchChoices, r = t.some((function (e) {
                                                    return !e.active
                                                }));
                                            if (e && e.length >= n) {
                                        ...
                                        var t = e.keyCode, i = this._store.activeItems, n = this.input.isFocussed,
                                            ...
                                            s = String.fromCharCode(t), a = /[a-zA-Z0-9-_ ]/.test(s),
                                            c = d.KEY_CODES.BACK_KEY, l = d.KEY_CODES.DELETE_KEY, u = d.KEY_CODES.ENTER_KEY,
                                            h = d.KEY_CODES.A_KEY, p = d.KEY_CODES.ESC_KEY, f = d.KEY_CODES.UP_KEY,
                                            m = d.KEY_CODES.DOWN_KEY, v = d.KEY_CODES.PAGE_UP_KEY,
                                        ...
                                        var t = e.target, i = e.keyCode, n = this.input.value, o = this._store.activeItems,
                                            r = this._canAddItem(o, n), s = d.KEY_CODES.BACK_KEY,
                                        ...
                                        var i = e.keyCode, n = e.metaKey, o = d.KEY_CODES.DOWN_KEY,
                                            r = d.KEY_CODES.PAGE_UP_KEY, s = d.KEY_CODES.PAGE_DOWN_KEY;
                                        ...
                                        var t = e.value, i = e.label, n = void 0 === i ? null : i, o = e.choiceId,
                                            ...
                                            c = e.customProperties, u = void 0 === c ? {} : c, h = e.placeholder,
                                            p = void 0 !== h && h, f = e.keyCode, m = void 0 === f ? -1 : f,
                                            v = "string" == typeof t ? t.trim() : t, _ = this._store.items, g = n || v,
                                            y = r || -1, E = a >= 0 ? this._store.getGroupById(a) : null,
                                            b = _ ? _.length + 1 : 1;
                                        ...
                                        var t = e.value, i = e.label, n = void 0 === i ? null : i, o = e.isSelected,
                                            r = void 0 !== o && o, s = e.isDisabled, c = void 0 !== s && s, l = e.groupId,
                                            u = void 0 === l ? -1 : l, h = e.customProperties, d = void 0 === h ? {} : h,
                                            p = e.placeholder, f = void 0 !== p && p, m = e.keyCode,
                                            v = void 0 === m ? -1 : m;
                                        if (null != t) {
                                        ...
                                        }), this.choiceList = new h.List({element: this._getTemplate("choiceList", this._isSelectOneElement)}), this.itemList = new h.List({element: this._getTemplate("itemList", this._isSelectOneElement)}), this.dropdown = new h.Dropdown({
                            ...
                            var n = i(883), o = function () {
                                ...
                                return e.prototype.clear = function () {
                                    ...
                                    var i = this;
                                    if (e) {
                                        var n = this.element.offsetHeight, o = this.element.scrollTop + n,
                                            r = e.offsetHeight, s = e.offsetTop + r,
                            ...
                            t.DEFAULT_CLASSNAMES = {
                                ...
                                noChoicesText: "هیچ انتخابی برای انتخاب وجود ندارد",
                                itemSelectText: "برای انتخاب فشار دهید",
                                uniqueItemText: "فقط مقادیر منحصر به فرد را می توان اضافه کرد",
                                customAddItemText: "فقط مقادیری که با شرایط خاص مطابقت دارند می توانند اضافه شوند",
                            ...
                            function c(e, i, r) {
                                (r = r || {}).arrayMerge = r.arrayMerge || o, r.isMergeableObject = r.isMergeableObject || t, r.cloneUnlessOtherwiseSpecified = n;
                                var s = Array.isArray(i);
                                return s === Array.isArray(e) ? s ? r.arrayMerge(e, i, r) : a(e, i, r) : n(i, r)
                            }
                            ...
                            e.exports = function (e) {
                                ...
                                var r = i(2), s = i(8), a = i(0), c = function () {
                                    function e(t, i) {
                                        var n = i.location, o = void 0 === n ? 0 : n, r = i.distance,
                                            ...
                                            I = void 0 === S ? [] : S, O = i.shouldSort, C = void 0 === O || O,
                                            T = i.getFn, A = void 0 === T ? s : T, L = i.sortFn,
                                    ...
                                    return t = e, (i = [{
                                        ...
                                        key: "_analyze", value: function (e, t) {
                                            var i = e.key, n = e.arrayIndex, o = void 0 === n ? -1 : n, r = e.value,
                                                s = e.record, c = e.index, l = t.tokenSearchers,
                                            ...
                                            if (null != r) {
                                                ...
                                                if ("string" == typeof r) {
                                                    ...
                                                    if (this._log('Full text: "'.concat(r, '", score: ').concat(E.score)), this.options.tokenize) {
                                                        for (var b = r.split(this.options.tokenSeparator), S = [], I = 0; I < u.length; I += 1) {
                                                            var O = u[I];
                                ...
                                var o = i(3), r = i(4), s = i(7), a = function () {
                                    ...
                                    return t = e, (i = [{
                                        key: "search", value: function (e) {
                                            ...
                                            var s = this.options, a = s.location, c = s.distance, l = s.threshold,
                                                u = s.findAllMatches, h = s.minMatchCharLength;
                                ...
                                e.exports = function (e, t) {
                                    var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : / +/g,
                                        o = new RegExp(t.replace(i, "\\$&").replace(n, "|")), r = e.match(o), s = !!r,
                                        a = [];
                                ...
                                e.exports = function (e, t, i, r) {
                                    ...
                                    for (var C = [], T = 1, A = E + _, L = 1 << (E <= 31 ? E - 1 : 30), w = 0; w < E; w += 1) {
                                        ...
                                        A = D;
                                        var N = Math.max(1, v - D + 1), x = p ? _ : Math.min(v + D, _) + E,
                                            M = Array(x + 2);
                                        M[x + 1] = (1 << w) - 1;
                                        for (var j = x; j >= N; j -= 1) {
                                            var F = j - 1, k = i[e.charAt(F)];
                                            if (k && (b[F] = 1), M[j] = (M[j + 1] << 1 | 1) & k, 0 !== w && (M[j] |= (C[j + 1] | C[j]) << 1 | 1 | C[j + 1]), M[j] & L && (T = n(t, {
                                                errors: w,
                                                currentLocation: F,
                                                expectedLocation: v,
                                                distance: l
                                ...
                                e.exports = function (e, t) {
                                    var i = t.errors, n = void 0 === i ? 0 : i, o = t.currentLocation,
                                        r = void 0 === o ? 0 : o, s = t.expectedLocation, a = void 0 === s ? 0 : s,
                                        c = t.distance, l = void 0 === c ? 100 : c, u = n / e.length,
                                        h = Math.abs(a - r);
                                ...
                                e.exports = function (e, t) {
                                    return function e(t, i, o) {
                                        if (i) {
                                            ...
                                            var c = t[s];
                                            if (null != c) if (a || "string" != typeof c && "number" != typeof c) if (n(c)) for (var l = 0, u = c.length; l < u; l += 1) e(c[l], a, o); else a && e(c, a, o); else o.push(c.toString())
                                        } else o.push(t);
                                        return o
                                    }(e, t, [])
                                }
    ...
    i.n = e => {
        ...
        "use strict";
        for (var e = i(4529), t = i.n(e), n = document.querySelectorAll(".choices"), o = 0; o < n.length; o++) n[o].classList.contains("multiple-remove") ? new (t())(n[o], {
            delimiter: ",",
            editItems: !0,
            maxItemCount: -1,
            removeItemButton: !0
