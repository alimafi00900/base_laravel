try {
  ...
  document
    .querySelectorAll(".vertification input")
    .forEach(
      (el) =>
        (el.onkeyup = (e) => e.target.value && el.parentElement.nextElementSibling.querySelector("input").focus())
    );

  const swiper_1 = new Swiper(".slider", {
    spaceBetween: 24,
    loop: true,
    navigation: {
  ...
  const swiper = new Swiper(".swiper.swiper-recommended-products", {
    slidesPerView: 8,
    spaceBetween: 24,
    pagination: {
  ...
  const swiper_2 = new Swiper(".swiper.swiper-widgets", {
    slidesPerView: 8,
    spaceBetween: 12,
    loop: true,
    pagination: {
  ...
  navToggler &&
    navToggler.addEventListener("click", (e) => {
      ...
      nav && nav.classList.contains("show")
