...
class TextToImage {
     ...
     */
    function createImage($text, $textColor = '', $backgroundColor = '#ffffff', $fontSize = 28, $imgWidth = 117, $imgHeight = 47) {
        //text font path
        $font = public_path("userAssets/fonts/woff/KalamehWeb-Thin.woff");
        //create the image
        $this->image = imagecreatetruecolor($imgWidth, $imgHeight);
        $colorCode = array('#000000');
