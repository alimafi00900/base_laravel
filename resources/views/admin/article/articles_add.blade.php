@php
    $template_name="articles_add";
    $template_name_fa="اضافه کردن مقاله";
@endphp
                        ...
                        <div class="card">
                            ...
                            <div class="col-12 mt-3 pb-3">
                                <form class="form-horizontal" role="form"
                                      method="POST" action="{{route("admin.articles_add_submit")}}"
                                    ...
                                    <div class="row">
                                        <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="col-md-12">
                                                    <label for="" class="mt-4 text-dark">عنوان</label>
                                                    <input type="text" class="form-control" id="name-input-from"
                                                           name="title"
                                                           required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="" class="mt-3 text-dark">وضعیت</label>
                                                ...
                                                <div class="col-md-12">
                                                    <label for="" class="mt-3 text-dark">دسته بندی مقاله</label>
                                                    <select class="custom-select" name="articleCategory" required>
                                                        <option selected value="1">پست خبری</option>
                                                        <option value="2">مقاله اموزشی</option>
                                                    </select>
                                                    <br>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="" class="mt-3 text-dark">تگ ها</label>
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="col-md-12 mt-2">
                                                    <label for="" class="mt-5 text-dark">تصویر</label>
                                        ...
                                        <div class="row mt-3">
                                            <div class="col-12">
                                                <label for="" class="mt-5 text-dark">محتوا</label>
                                                <textarea rows="30" type="text" id="article-content"
                                                          class="form-control"
                                                          name="content"
                                                ></textarea></div>
                                        </div>
