@php
    $template_name="productCategories_edit";
    $template_name_fa="ویرایش دسته بندی";
@endphp
                        ...
                        <div class="card">
                            ...
                            <div class="col-12 mt-3 pb-3">
                                <form class="form-horizontal" role="form"
                                      ...
                                      action="{{route("admin.productCategories_edit_category_submit",[$productCategory->id])}}"
                                    ...
                                    <div class="row">
                                            ...
                                            <div class="col-md-6 col-12">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" id="name-input-from"
                                                           name="title"
                                                           value="{{$productCategory->title}}" required>
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="" class="mt-4">شاخه</label>
                                                    @include("admin.layouts.partials.searchItem.searchItemHtml",["itemName"=>"branches","itemInputValue"=>"$productCategory->branches"])
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="" class="mt-3">وضعیت</label>
                                                    <select class="custom-select" name="status" required>
                                                        <option @if($productCategory->status=="active") selected
                                                                @endif value="1">فعال
                                                        </option>
                                                        <option @if($productCategory->status=="deactivate") selected
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" id="name-input-form"
                                                           value="{{$productCategory->instagram_link}}"      name="instagram_link"
                                                    >
                                                </div>
                                                <div class="col-md-12">
                                                    <label for="" class="mt-4">لینک واتساپ</label>
                                                    <input type="text" class="form-control" id="name-input-form"
                                                           value="{{$productCategory->whatsapp_link}}"     name="whatsapp_link"
                                                    >
                                                </div>
                                            </div>
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="image-input box ">
                                                        @if(isValidValue($productCategory->img_link))
                                                            <div class="js--image-preview js--no-default js--no-default"
                                                                 style="background: url('{{asset($productCategory->img_link)}}')">
                                                            </div>
                                                        @else
                                            ...
                                            <div class="col-md-4 col-12">
                                                <div class="col-md-12">
                                                    ...
                                                    <div class="image-input box ">
                                                        @if(isValidValue($productCategory->poster))
                                                            <div class="js--image-preview js--no-default js--no-default"
                                                                 style="background: url('{{asset($productCategory->poster)}}')">
                                                            </div>
                                                        @else
                                                            <div class="js--image-preview"></div>
                                                        @endif
                                        ...
                                        <div class="row mt-3">
                                            ...
                                            <textarea rows="30" type="text" id="article-content" class="form-control"
                                                      name="content"
                                            >{!! $productCategory->content !!}</textarea>
                                            <br>
                                        </div>
                                        <div class="row mt-3">
                                                    ...
                                                    @foreach($forms as  $formKey =>$formValue)
                                                        <div class="card pb-3 single-form" style="background: #c9c9c9;">
                                                            <div class="border mt-3 mx-2 py-3 row"
                                                                ...
                                                                <span id="title-form"
                                                                      class="text-dark">{{" حالت ".$formLoopIndex}}</span>
                                                                <div class="col-4">
                                                                    <label for="" class="mt-4">نام حالت (انگلیسی و بدون
                                                                        فاصله باشد)</label>
                                                                    <input type="text" id="form-name"
                                                                           value="{{$formKey}}" class="form-control">
                                                                </div>
                                                                <div class="col-4">
                                                                    <label for="" class="mt-4">عنوان حالت</label>
                                                                    <input type="text" id="form-title"
                                                                           value="{{getProperty($formValue,"form_title")}}"
                                                                           class="form-control">
                                                                </div>
                                                                <div class="col-4">
                                                                    <label for="" class="mt-4">توضیحات حالت</label>
                                                                    <textarea rows="2" id="form-description"
                                                                              class="form-control">{{getProperty($formValue,"form_description")}}</textarea>
                                                                </div>
                                                            </div>
                                                            <div id="list-field" class="">
                                                                @php
                                                                    $fields=getProperty($formValue,"form_fields");
                                                                     $fieldLoopIndex=1;
                                                                       if($fields==null){
                                                                           $fields=[];
                                                                       }
                                                                ...
                                                                @foreach($fields as $fieldKey => $fieldValue)
                                                                    <div class="border-top single-field-form card py-4 col-12">
                                                                        <div class="row">
                                                                            <span id="title-field"
                                                                                  class="text-dark">{{" حالت ".$formLoopIndex}} {{"-> فیلد ".$fieldLoopIndex}} </span>
                                                                            <div class="col-md-4 col-12">
                                                                                <label for="" class="mt-4">نام فیلد
                                                                                    (انگلیسی
                                                                                    و
                                                                            ...
                                                                            <div class="col-md-4 col-12">
                                                                                <label for="" class="mt-4">سرتیتر
                                                                                    فیلد</label>
                                                                                <input type="text" id="field-title"
                                                                                       value="{{getProperty($fieldValue,"field_title")}}"
                                                                                       class="form-control">
                                                                            </div>
                                                                            <div class="col-12 col-md-4">
                                                                                <label for="" class="mt-4">توضیحات
                                                                                    فیلد</label>
                                                                                <textarea id="field-description"
                                                                                          rows="2"
                                                                                          class="form-control">{{getProperty($fieldValue,"field_description")}}</textarea>
                                                                            </div>
                                                                        </div>
                                                                        <div class="row px-4 my-4">
                                                                            ...
                                                                            <div class=" col-4 col-md-3 d-flex align-items-center ">
                                                                                <input class="form-check-input"
                                                                                       type="radio"
                                                                                       id="field-condition"
                                                                                       @if(getProperty($fieldValue,"field_condition")=="number") checked
                                                                                       @endif
                                                                                       value="number"
                                                                                       name="type_input_{{$formKey}}_{{$fieldKey}}">
                                                                            ...
                                                                            <div class=" col-4 col-md-3 d-flex align-items-center ">
                                                                                <input class="form-check-input"
                                                                                       value="email"
                                                                                       type="radio"
                                                                                       @if(getProperty($fieldValue,"field_condition")=="email") checked
                                                                                       @endif
                                                                                       id="field-condition"
                                                                                       name="type_input_{{$formKey}}_{{$fieldKey}}">
                                                                            ...
                                                                            <div class=" col-4 col-md-3 d-flex align-items-center ">
                                                                                <input class="form-check-input"
                                                                                       value="password"
                                                                                       @if(getProperty($fieldValue,"field_condition")=="password") checked
                                                                                       @endif type="radio"
                                                                                       id="field-condition"
                                                                                       name="type_input_{{$formKey}}_{{$fieldKey}}">
                                                                            ...
                                                                            <div class=" col-4 col-md-3 d-flex align-items-center ">
                                                                                <input class="form-check-input"
                                                                                       ...
                                                                                       id="field-condition" value="text"
                                                                                       name="type_input_{{$formKey}}_{{$fieldKey}}"
                                                                                       @if(getProperty($fieldValue,"field_condition")=="none") checked @endif >
                                                                                <span class="text-black  ">متن عادی</span>
                                                                            </div>
                                                                            <div class=" col-4 col-md-3 d-flex align-items-center ">
                                                                                <input class="form-check-input"
                                                                                       @if(getProperty($fieldValue,"field_required")==true) checked
                                                                                       @endif
                                                                                       type="checkbox"
                                                                                       id="field-required">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-3 col-6">
                                                                                ...
                                                                                <input type="number"
                                                                                       id="field-min-chars"
                                                                                       value="{{getProperty($fieldValue,"field_min_chars")}}"
                                                                                       class="form-control">
                                                                            </div>
                                                                            <div class="col-md-3 col-6">
                                                                                ...
                                                                                <input type="number"
                                                                                       id="field-max-chars"
                                                                                       value="{{getProperty($fieldValue,"field_max_chars")}}"
                                                                                       class="form-control">
                                                                            </div>
                                                            ...
                                                            <div class="d-flex w-100 justify-content-end">
                                                                <a id="add-field-form"
                                                                   class="btn btn-success btn-sm text-light">افزودن فیلد
                                                                    جدید</a>
                                                                <a id="remove-field-form"
                                                                   class="btn btn-danger btn-sm  text-light"> حذف فیلد
                                                                    حالت</a>
                                                            </div>
                                                        </div>
                                                        @php
        ...
        @section("js")
            ...
            <script>
                ...
                $(document).ready(function () {
                    $("[name='tags']").val("{{$productCategory->tags}}")
                    gettags();
                });
            </script>
