...
@php
    $templateName_route_name="admin.comments";
    $templateName_single_fa="کامنت";
    $templateName_sum_fa="کامنت ها";
@endphp
...
{{--                <input id="item-id-{{$comment->id}}" type="checkbox" style="margin:-7px" class="form-check-input ">--}}
{{--            </td>--}}
{{--            -----------------}}



{{--            <td class="text-center">{{$comment->index_num}}</td>--}}

{{--            <td class="text-center">{{$comment->nav_type}}</td>--}}

{{--            <td class="text-center">{{$comment->name}}</td>--}}

{{--            <td class="text-center">{{$comment->link}}</td>--}}
...
{{--                   href="{{route($templateName_route_name."_submit",[$comment->id])}}">--}}
{{--                    <i class="fa fa-edit" aria-hidden="true"></i>--}}
{{--                </a>--}}
{{--                <button class="btn btn-sm btn-danger" style="cursor: pointer"--}}
{{--                        onclick="deleteItemModal('{{$comment->id}}')"><i--}}
                                        ...
                                        <tr class="font-weight-bold">
                                            ...
                                            <td class="text-center">
                                                <a class="btn btn-sm btn-success"
                                                   {{route($templateName_route_name."_submit",[$comment->id])}}
                                                   href="#">
