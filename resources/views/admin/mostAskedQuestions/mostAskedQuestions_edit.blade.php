    ...
    <div class="row ">
        ...
        <div class="col-md-6">
            ...
            <input type="text" class="form-control" id="name-input-from" name="title"
                   value="{{$most_asked_questions->title}}"
                   required>
            <br>
        </div>
        ...
        <div class="col-md-6">
            ...
            <select class="custom-select" name="status" required>
                <option @if($most_asked_questions->status == "active") selected @endif value="1">فعال</option>
                <option @if($most_asked_questions->status == "deactivate") selected @endif value="2">غیر فعال</option>
            </select>
            <br>
        </div>
        ...
        <div class="row">
            ...
            <textarea rows="30" type="text" id="article-content" class="form-control"
                      name="content"
            >{{$most_asked_questions->content}}</textarea>
