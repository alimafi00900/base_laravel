...
@section("content")
    @php
        $comments=App\Models\comment::where('section',"product_category")->where('post_id',$news->id)->get()->reverse();
    @endphp
    <main>
        <div class="container-lg container-fluid">
            <div class="row">
                ...
                <div class="col-12">
                    <div class="content-info">
                        ...
                        <div class="content-info-LikeComment">
                            @php
                                $marks=(array)json_decode($news->marks);
                            @endphp
                            ...
                            @php
                                $likes=(array)json_decode($news->likes);
                            @endphp
                        ...
                        <div class="content-info-author">
                            ...
                            <div class="content-info-author-info">
                                <span>{{getProperty(App\Models\adminUser::where("id",$news->author_id)->first(),"name")}}</span>
                ...
                <div class="row">
                    <div class="col-12 col-md-7 h-100 col-lg-8 col-xl-9 mt-2">
                        {!! $news->content !!}
                    </div>
                    <div class="col-12 col-md-5 col-lg-4 col-xl-3 my-4 sticky-md-top">
                        <div class="row">
                            <div class="col-12 " >
                                <div class="bg-box">
                                    <div class="topic-top topic-top-t">
                                        <h4>
                                            جدیدترین مطالب
                                        </h4>
                                    </div>
                                    @foreach(App\Models\article::where("article_category","news")->where('status','active')->orderBy('created_at', 'desc')->get()->take(7) as $item)
                                    <div class="sibar-list-blog">
                                        <img src="{{asset($item->img_link)}}" alt="">
                                        <div class="sibar-list-blog-content">
                                            <a>
                                                 {{$item->title}}
                                            </a>
                                            <span>{{$item->date}}</span>
                    ...
                    <div class="sharing">
                     <span>
                        ...
                        <div class="sharing-link"
                             onclick="copyLink('{{route("user.single_product_category",$news->slug)}}')">
                        <span>
                           کپی لینک
                        </span>
                ...
                <div class="col-12 col-md-6 mt-5">
                    <div class="bg-box">
                        ...
                        <form id="comment-from" action="{{route('user.comment_submit')}}" method="post">
                            ...
                            <input name="pi" type="hidden" value="{{$news->id}}">
                            <div class="form-gr">
