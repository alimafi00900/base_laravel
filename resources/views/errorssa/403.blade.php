...
<head>
    ...
    <title> {{env('APP_NAME_FA')}} | خطای ۴۰۳</title>
    ...
    <div class="error-page container" style="margin: 0 auto">
        <div class="col-md-8 col-12 offset-md-2">
            <div class="text-center">
                <img class="img-error" src="/adminAssets/images/samples/error-403.svg" alt="Not Found">
                <h1 class="error-title">خطای دسترسی</h1>
                <p class='fs-5 text-gray-600'>دسترسی شما به این قسمت محدود شده است</p>
